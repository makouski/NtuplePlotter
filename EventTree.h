...
public:
	...
	// http://cmssw.cvs.cern.ch/cgi-bin/cmssw.cgi/UserCode/ggAnalysis/ggNtuplizer/plugins/ggNtuplizer.cc?revision=1.241
	...
	Float_t  eleIDMVATrigIDIso_[maxP];
	...
	Float_t  phoE2x5Right_[maxP];
	Float_t  phoE2x5Left_[maxP];
	Float_t  phoE2x5Top_[maxP];
	Float_t  phoE2x5Bottom_[maxP];
	Float_t  phoE5x1_[maxP];
	Float_t  phoE1x5_[maxP];
	Float_t  phoE3x1_[maxP];
	Float_t  phoE1x3_[maxP];
	Float_t  phoE2x2_[maxP];
	Float_t  phoEtop_[maxP];
	Float_t  phoEbottom_[maxP];
	Float_t  phoEleft_[maxP];
	Float_t  phoEright_[maxP];
